@article{nielsen2015neural,
  ...
  journal={URL: http://neuralnetworksanddeeplearning.com/chap4.html.(visited: 01.11. 2014)},
  year={2015}
}
...
@inproceedings{Anders2016quant,
  author    = {Anders {\O}land and
               Bhiksha Raj},
  title     = {Reducing communication overhead in distributed learning by an order
               of magnitude (almost)},
...
@article{deepcompression2016,
  title={DEEP COMPRESSION: COMPRESSING DEEP NEURAL NETWORKS WITH PRUNING, TRAINED QUANTIZATION AND HUFFMAN CODING},
  author={Han, Song and Mao, Huizi and Dally, William J},
  journal={arXiv preprint arXiv:1510.00149v5},
  year={2016}
}
